...
export function Avatar(props) {
  ...
  const [shouldPlayOnLoad, setShouldPlayOnLoad] = useState(true);
  ...
  const { nodes, materials } = useGLTF("/models/64c2b281588332d805c52a36.glb");
...
useGLTF.preload("/models/64c2b281588332d805c52a36.glb");
